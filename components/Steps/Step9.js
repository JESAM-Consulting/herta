...
export default function Step9() {
  ...
  const config = {
    headers: {
      "X-API-Account": "743243287",
      "X-API-Key":
        "Gnu1ngPhaSC26Y0G5KJ189qiY6vHOgp4fPqrn5bVFWjy3ZmDcSGnu1ngPhaSC26Y0G5KJ189qiY6vHOgp4fPqrn5bVFWjy3ZmDcSGnu1ngPhaSC26Y0G5KJ189qiY6vHOgp4fPqrn5bVFWjy3ZmDcSGnu1ngPhaSC26Y0G5KJ189qiY6vHOgp4fPqrn5bVFWjy3ZmDcSGnu1ngPhaSC26Y0G5KJ189qiY6vHOgp4fPqrn5bVFWjy3ZmDcS",
    },
  };
    ...
    <div data-show={step == 9 ? true : false} className="step">
      ...
      <form ref={myForm} onSubmit={handleSubmit(onSubmit)} className="  mt-7">
        ...
        <div className="flex space-x-4">
          <button
            type="submit"
            className="mt-4 bg-green-1 items-center justify-center flex outline-none relative lg:px-12 lg:text-base md:px-8 font-visby font-bold py-3 rounded-md hover:cursor-pointer text-[#F1C88B] transition-all ease-in-out duration-150 hover:bg-opacity-90 md:text-sm md:w-auto text-sm w-full">
